...
//		show(program);  //It may be useful useful to show this here if code generation fails
	...
	public void Dec() throws Exception {
		String prog = "Dec";	
		String input = prog + "{image x [1,2];"
				//+ "image x;"
				+ "int y;"
				+ "float b; boolean c; filename d;}";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {};
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n "+RuntimeLog.globalLog);
	...
	@Test
	public void showProgInt() throws Exception {
		String prog = "showProg";	
	...
	@Test
	public void showProgFloat() throws Exception {
		String prog = "showProg";	
		String input = prog + "{show 3.1;}";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {};
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n "+RuntimeLog.globalLog);
	...
	@Test
	public void showProgBoolean() throws Exception {
		String prog = "showProg";	
	...
	@Test
	public void sleepProg() throws Exception {
		String prog = "sleepProg";	
		String input = prog + "{sleep 4;}";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {};
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n "+RuntimeLog.globalLog);
	...
	@Test
	public void lhsIdentProg() throws Exception {
		String prog = "lhsIdentProg";	
		String input = prog + "{int x; x:=3;}";
		byte[] bytecode = genCode(input);
		String[] commandLineArgs = {};
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n "+RuntimeLog.globalLog);
	...
	@Test
	public void unaryEProg1() throws Exception {
		String prog = "unaryEProg1";
	...
	public void testExpressionPixelConstructor2() throws Exception {
		...
		String input = prog + "{show <<255,255,0,0>>;}";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = { "0", "5"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	}
