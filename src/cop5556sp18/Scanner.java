...
public class Scanner {
	...
	public static enum Kind {
		...
		KW_width /* width */, KW_height /* height*/, KW_sleep/*sleep*/, KW_show/*show*/, KW_write /* write */, KW_to /* to */,
	...
	Scanner(String inputString) {
	 ...
	 private enum State {
		 ...
		 HAVE_ZERO, 
		 HAVE_EQUAL, // ==
		 HAVE_GT, HAVE_LT, HAVE_COLON, HAVE_EXCLAMATION, HAVE_TIMES,
		 HAVE_SLASH,
		 COMMENT //NOT_COMMENT
			...
			switch(state) {
					...
					switch(ch) {
						...
						default: {
							if(Character.isDigit(ch)) {
								...
								long l = Long.valueOf(String.valueOf(chars, startPos, pos-startPos));
				...
				case FLOAT_LITERAL: {
					if (Character.isDigit(ch)) {
						...
						float m = Float.parseFloat(String.valueOf(chars, startPos, pos-startPos));
