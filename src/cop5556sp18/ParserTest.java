...
public class ParserTest {
	...
	@Test
	public void testUnary2() throws LexicalException, SyntaxException {
		String input = "4 ** 2 ** 3";
		Parser parser = makeParser(input);
		Expression e = parser.expression();  //call expression here instead of parse
		show(e);	
		...
		ExpressionBinary b1 = (ExpressionBinary)b.leftExpression;
		assertEquals(ExpressionIntegerLiteral.class, b1.leftExpression.getClass());
		ExpressionIntegerLiteral left1 = (ExpressionIntegerLiteral)b1.leftExpression;
		assertEquals(4, left1.value);
		assertEquals(ExpressionIntegerLiteral.class, b1.rightExpression.getClass());
		ExpressionIntegerLiteral right1 = (ExpressionIntegerLiteral)b1.rightExpression;
		assertEquals(2, right1.value);
		
		assertEquals(ExpressionIntegerLiteral.class, b.rightExpression.getClass());
		ExpressionIntegerLiteral right2 = (ExpressionIntegerLiteral)b.rightExpression;
		assertEquals(3, right2.value);
		
		assertEquals(OP_POWER, b1.op);
		assertEquals(OP_POWER, b.op);
	}
	
	@Test
	public void testUnary1() throws LexicalException, SyntaxException {
		String input = "4 ** 2";
		Parser parser = makeParser(input);
		Expression e = parser.expression();  //call expression here instead of parse
		show(e);	
		assertEquals(ExpressionBinary.class, e.getClass());
		ExpressionBinary b1 = (ExpressionBinary)e;
		assertEquals(ExpressionIntegerLiteral.class, b1.leftExpression.getClass());
		ExpressionIntegerLiteral left = (ExpressionIntegerLiteral)b1.leftExpression;
		assertEquals(4, left.value);
		assertEquals(ExpressionIntegerLiteral.class, b1.rightExpression.getClass());
		ExpressionIntegerLiteral right = (ExpressionIntegerLiteral)b1.rightExpression;
		assertEquals(2, right.value);
		assertEquals(OP_POWER, b1.op);
	}
